...
/**
 * Base interface for drawable graphics that can also be selected for
 * manipulation. Created by Gustavo on 2017-06-17.
 */
public interface SelectableDrawable {
  ...
  /**
   * Returns true if the point (px, py) is contained within this drawable's
   * shape.
   * 
   * @param px
   * @param py
